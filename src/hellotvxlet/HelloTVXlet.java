...
public class HelloTVXlet implements Xlet, HActionListener {
    ...
    public void actionPerformed (ActionEvent e){
        ...
        if(e.getActionCommand() == "knop1_actioned"){
            resultaat.setTextContent("Van bit naar byte = x/8", HState.NORMAL_STATE);
        }
        if(e.getActionCommand() == "knop2_actioned"){
            resultaat.setTextContent("Van byte naar bit = x*8", HState.NORMAL_STATE);
        }
    ...
    public void initXlet(XletContext context) throws XletStateChangeException {
        ...
        scene = HSceneFactory.getInstance().getBestScene(sceneTemplate);
            ...
            // titel
            titel = new HTextButton("How to convert B to b");
